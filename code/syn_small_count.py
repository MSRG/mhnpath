...
path = 'syn_small_mhn_shuffled.csv'
# path = '/Users/shivesh/Downloads/enzyme/enz_mhn/enz_mhn_shuffled.csv'
out = 'syn_small.csv'
...
for index, row in df.iterrows():
    if len(row['prod_smiles']) > 700 or len(row['reactants_can']) > 700:
        continue

    product_part = row['prod_smiles']

    reactant = row['reactants_can']   
